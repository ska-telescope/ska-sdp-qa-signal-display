context('Signal display', () => {
    ...
    it('Verify expected diagrams are present and can be hidden', () => {
        ...
        cy.findByText("Spectrum Plot XX").should("be.visible")
        cy.findByText("Spectrum Plot XY").should("be.visible")
        cy.findByText("Spectrum Plot YX").should("be.visible")
        cy.findByText("Spectrum Plot YY").should("be.visible")
