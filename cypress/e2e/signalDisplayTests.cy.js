context('Signal display', () => {
    ...
    it('Verify expected diagrams are present and can be hidden', () => {
        ...
        cy.get("#polar1XXSvg").should("be.visible")
        cy.findByText("Polarization XY").should("be.visible")
        cy.get("#polar0XYSvg").should("be.visible")
        cy.get("#polar1XYSvg").should("be.visible")
        cy.findByText("Polarization YX").should("be.visible")
        cy.get("#polar0YXSvg").should("be.visible")
        cy.get("#polar1YXSvg").should("be.visible")
        cy.findByText("Polarization YY").should("be.visible")
        cy.get("#polar0YYSvg").should("be.visible")
        cy.get("#polar1YYSvg").should("be.visible")
