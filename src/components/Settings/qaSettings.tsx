...
export const QASettings = {
  ...
  showSpectrumPlotXXaxisY: amplitudeAxisY[0],
  ...
  showPolarizationAmplitudeXXaxisY: amplitudeAxisY[0],
  showPolarizationAmplitudeXYaxisY: amplitudeAxisY[0],
  showPolarizationAmplitudeYXaxisY: amplitudeAxisY[0],
  showPolarizationAmplitudeYYaxisY: amplitudeAxisY[0],
  //
  ...
  showcrossElevationFittedWidthaxisY: amplitudeAxisY[0],
  showelevationFittedWidthaxisY: amplitudeAxisY[0],
