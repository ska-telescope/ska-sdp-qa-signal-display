...
const AmpFreq = ({ resize }: AmpFreqProps) => {
  ...
  const connectToWebSocket = React.useCallback(async () => {
    const d3Chart0 = getChart('#ampFreq0Svg', 0, ampFreq0Ref.current.offsetWidth);
    const d3Chart1 = getChart('#ampFreq1Svg', 1, ampFreq1Ref.current.offsetWidth);
    const d3Chart2 = getChart('#ampFreq2Svg', 2, ampFreq2Ref.current.offsetWidth);
    const d3Chart3 = getChart('#ampFreq3Svg', 3, ampFreq3Ref.current.offsetWidth);
