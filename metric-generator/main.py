...
from core.config import BROKER_API, MEASUREMENT_SET

t = table(MEASUREMENT_SET, ack=False)
...
num_pols = tablecolumn(table(t.getkeyword("POLARIZATION"), ack=False), "NUM_CORR")[0]
...
requests.post(BROKER_API, json=payload)
